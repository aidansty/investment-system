...
INDUSTRY_STOCK_LEADERS = {
    ...
    "Cybersecurity":         ["CRWD", "PANW", "ZS", "FTNT", "S", "OKTA", "RPD", "TENB", "QLYS", "SAIL", "CHKP", "AKAM", ],
    "AI Infrastructure":     ["NVDA", "MSFT", "GOOGL", "AMZN", "META", "AMD", "ORCL", "IBM", "SMCI", "ARM", "CRWV", "PLTR", "AI", "IONQ", "RGTI"],
    "Cloud Computing":       ["AMZN", "MSFT", "GOOGL", "NET", "SNOW", "DDOG", "ESTC", "FSLY", "FIVN", "TWLO", "BOX", "DOCN", "WK", "APPN"],
    "Networking":            ["CSCO", "ANET", "CIEN", "VIAV", "NTGR", "CALX", "RBBN", "AAOI", "LITE", "COHR", ],
    "Biotech":               ["AMGN", "GILD", "REGN", "VRTX", "MRNA", "BIIB", "ILMN", "ALNY", "BMRN", "IONS", "RARE", "ACAD"],
    "Medical Devices":       ["ABT", "MDT", "ISRG", "SYK", "BSX", "EW", "ZBH", "BAX", "BDX", "TFX", "DXCM", "PODD", "INSP", ],
    ...
    "Energy Transition":     ["ENPH", "FSLR", "SEDG", "NEE", "PLUG", "RUN", "ARRY", "SHLS", "STEM", "BE", "BLDP", "FCEL", "CSIQ", "JKS"],
    "Oil & Gas":             ["XOM", "CVX", "COP", "SLB", "EOG", "OXY", "DVN", "MPC", "VLO", "PSX", "APA", "FANG", "HAL"],
    "Financials":            ["JPM", "BAC", "GS", "MS", "V", "MA", "AXP", "BLK", "SCHW", "COF", "SYF", "ALLY", "SOFI", "NDAQ"],
    "Regional Banks":        ["WFC", "USB", "PNC", "TFC", "MTB", "CFG", "HBAN", "RF", "KEY", "FITB", "UMBF", "BOKF", "EWBC"],
